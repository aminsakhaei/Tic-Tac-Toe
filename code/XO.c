...
void winner_check(){
sum[0]=game[0]+game[1]+game[2];          //ROW1
sum[1]=game[3]+game[4]+game[5];          //ROW2
sum[2]=game[6]+game[7]+game[8];          //ROW3
sum[3]=game[0]+game[3]+game[6];          //COLUMN1
sum[4]=game[1]+game[4]+game[7];          //COLUMN2
sum[5]=game[2]+game[5]+game[8];          //COLUMN3
sum[6]=game[0]+game[4]+game[8];          //MAIN DIAGONAL
sum[7]=game[2]+game[4]+game[6];          //ANTI DIAGONAL
}
